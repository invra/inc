...
linkFarm name [
  {
    name = "colored-1.0.0-k8xvmZE2AAAf5ABnPMKeJ8vwoZf-XHyh9hVL0Nd_Zqz2";
    path = fetchZigArtifact {
      name = "colored";
      url = "git+https://github.com/invra/colored.zig#54f9cc316f56f70458bacef117fa18a3f1140bee";
      hash = "sha256-3kFXJUMqpQbwDe1g7VDeTduxQgUU4fEBAND4ChP9he0=";
      unpack = true;
    };
  }
]
